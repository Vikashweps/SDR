...
vector<complex<float>> OFDM(const vector<complex<float>>& symbols,int Nc = 64);
vector<complex<float>> OFDM_Demodulate(const vector<complex<float>>& rx_signal,  int Nc = 64);    
